...
<body>
    ...
    def _serve_stream(self):
        ...
        try:
            ...
            # Keep the legacy local-stream behavior: browsers can be slow, and
            # aggressively disconnecting a client here causes the visible lag
            # that reappears on Pi5 even while external publishers continue to
