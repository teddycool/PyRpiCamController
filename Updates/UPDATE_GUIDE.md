...
```
Updates/
├── camcontroller_update_daemon.py    # Background daemon for automatic checks
├── camcontroller_update_manager.py   # Main update manager (robust version)
├── camcontroller_update_legacy.py    # Legacy implementation (deprecated)
├── camcontroller-update.service      # Systemd service file
...
![OTA Process Diagram](../_doc/ota_process_professional.png)
...
tail -f /home/pi/shared/logs/camcontroller_update.log
```
...
grep "Checking for updates" /home/pi/shared/logs/camcontroller_update.log | tail -5

# Check for recent errors
grep "ERROR" /home/pi/shared/logs/camcontroller_update.log | tail -10
```
