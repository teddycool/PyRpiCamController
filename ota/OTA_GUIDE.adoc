...
├── ota-daemon.service      # Systemd service for OTA daemon
...
----
{
  ...
  "OTA": {
    ...
    "service_name": "pycam.service",     // Systemd service to manage
...
----
# Copy service file
sudo cp ota/ota-daemon.service /etc/systemd/system/

# Reload systemd
sudo systemctl daemon-reload

# Enable service (start on boot)
sudo systemctl enable ota-daemon.service

# Start service
sudo systemctl start ota-daemon.service

# Check status
sudo systemctl status ota-daemon.service
----
...
* **Service Stop**: Camera services are gracefully stopped (pycam.service)
...
----
# OTA daemon logs
journalctl -u ota-daemon.service -f
...
* **OTA Daemon**: `journalctl -u ota-daemon.service`
...
systemctl status ota-daemon.service
...
sudo journalctl -u ota-daemon.service -n 50
----
...
----
# Check service status
systemctl status pycam.service

# Check recent logs
journalctl -u pycam.service -n 50
