...
* **fix_samba_anonymous.sh** - Utility script to fix Samba anonymous access issues
...
* **install/** - Update daemon and installation scripts
* **camcontroller-update.service** - Systemd service for the update daemon
